...
func TestChallenge1(t *testing.T) {
	var testCases = []struct {
		...
		{
			name:     "Example 1",
			input:    []string{"aaa: you hhh", "you: bbb ccc", "bbb: ddd eee", "ccc: ddd eee fff", "ddd: ggg", "eee: out", "fff: out", "ggg: out", "hhh: ccc fff iii", "iii: out"},
			expected: 5,
			error:    false,
		},
	}
...
func TestChallenge2(t *testing.T) {
	var testCases = []struct {
		...
		{
			name:     "Example 1",
			input:    []string{"svr: aaa bbb", "aaa: fft", "fft: ccc", "bbb: tty", "tty: ccc", "ccc: ddd eee", "ddd: hub", "hub: fff", "eee: dac", "dac: fff", "fff: ggg hhh", "ggg: out", "hhh: out"},
			expected: 2,
			error:    false,
		},
	}
